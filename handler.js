      ...
      for (let name in global.plugins) {
        ...
        if ((usedPrefix = (match[0] || '')[0])) {
          ...
          try {
            ...
            // if (m.limit) m.reply(+ m.limit + ' Limit terpakai') // Leave it as a comment if you are uncomfortable with this message
          }
          break
        }
      }
        ...
        case 'remove':
          if (chat.welcome) {
            ...
            for (let user of participants) {
              ...
              let pp = 'https://telegra.ph/file/b14a603ccc43f4781cc97.jpg'
              try {
